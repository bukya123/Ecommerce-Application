...
function DeleteModal({openDeleteModal,setOpenDeleteModal,title,onDeleteHandler}){
    return (
        <Dialog open={openDeleteModal} onClose={setOpenDeleteModal} className="relative z-50">
      <DialogBackdrop
        transition
